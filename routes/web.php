...
use App\Http\Middleware\UsuarioActivado;
...
Route::group(['middleware' => 'medico'], function () {         //Si es medico podrá acceder a las rutas del grupo
        ...
        Route::put('/usuarios/updatepassword/{id}', [UsuariosController::class,'updatePassword']);
      //  Route::get('/usuarios/updatepassword', [UsuariosController::class,'updatePassword']);
