        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <div
                v-if="userEdit.newPassword && !$v.userEdit.newPassword.minLength"
                class="invalid-feedback"
              >La contraseña debe tener un mínimo de 6 caracteres</div>
            </div>
            <div class="form-group">
              ...
              <div
                v-if="$v.userEdit.confirmPassword && !$v.userEdit.confirmPassword.sameAsPassword"
                class="invalid-feedback"
              >La contraseña y la contraseña de confirmación deben coincidir</div>
            </div>
            <div class="form-group">
              <button type="button" class="btn btn-dark" @click="updatePassword()">Guardar</button>
  ...
  methods: {
    updatePassword() {
      ...
      const promise = axios.put(
        "/usuarios/updatepassword/" + this.usuario.id,
        this.userEdit
      );
      promise
        .then((response) => {
