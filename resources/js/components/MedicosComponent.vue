  ...
  <div>
    ...
    <div class="row">
      <div class="col-xl-6 col-md-12">
        <div class="toolbar">
          <div class="botonera">
            <button type="button" class="btnview btn-outline-dark" @click="viewTable()">
              <i class="fa fa-table"></i>
            </button>
            <button type="button" class="btnview btn-outline-dark" @click="viewGird()">
        ...
        <div class="medicos" v-if="view==0">
          <div
            class="tarjeta"
            v-for="medico in arrayMedicos"
            :key="medico.id"
            @click="cargarMedico(medico)"
          >
            <div class="avatar">
        ...
        <div class="form-group">
          ...
          <select class="form-control" v-model="medicoEdit.user_id">
            <option
              ...
              :key="usuario.id"
              :value="usuario.id"
            >{{usuario.name}}-{{usuario.email}}</option>
          </select>
        </div>
