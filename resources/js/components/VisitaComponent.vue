        ...
        >
          <div class="tab-content" id="nav-tabContent">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="mb-3">
                    ...
                    >
                      <option v-for="motivo in motivosvisita" :key="motivo.id" :value="motivo.id">
                        {{
                        motivo.descripcion
                        }}
                      </option>
            ...
            >
              <div class="row justify-content-center">
                <div class="col-6">
                  <documentos-component :idvinculo="c_visita.id" :vinculo_doc="'visita_id'"></documentos-component>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <pruebasmedicas-component :visita="c_visita"></pruebasmedicas-component>
            </div>
          </div>
        </form>
      </div>
