<template>
  <div>
    <nav>
        <h2>Visita del paciente: {{ c_visita.paciente.apellidos }}, {{ c_visita.paciente.nombre}}</h2>
    ...
    <form method="post"  accept-charset="UTF-8" enctype="multipart/form-data" @submit.prevent="actualizarVisita">     
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="fecha" name="fecha" v-model="fecha" disabled>                                  
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="hora" class="form-label">Hora</label>
                                    <input type="time" class="form-control" id="hora" name="hora" v-model="hora" disabled
                                      >
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="tipo_visita_id" name="tipo_visita_id" v-model="c_visita.tipo_visita_id">                              
                                    <option v-for="tipo in tiposvisita" :key="tipo.id" :value="tipo.id" >{{ tipo.descripcion }}</option>                             
                            </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-3 ">
                                ...
                                <input type="number" class="form-control" id="peso" name="peso"
                                    v-model="c_visita.peso" @change="calculoBMI()">
                            </div>
                            <div class="col-3">
                                <label for="altura" class="form-label">Altura</label>
                                <input type="number" class="form-control" id="altura" name="altura" step="any"
                                     v-model="c_visita.altura" @change="calculoBMI()">
                            </div>
                            <div class="col-3">
                                <label for="IMC" class="form-label">IMC</label>
                                <input type="number" class="form-control" id="IMC" name="IMC" v-model="c_visita.IMC" disabled>
                            </div>
                            <div class="col-3">
                                ...
                                <input type="number" class="form-control" id="tension_arterial" name="tension_arterial"
                                   v-model="c_visita.tension_arterial">                                 
                            </div>
                        </div>
                        <div class="mb-3">
...
export default {
  ...
  created() {
    ...
    this.fecha=moment(this.c_visita.calendario.inicio).format('YYYY-MM-DD');
  ...
  methods:{
    actualizarVisita() { 
      ...
      const promise=axios.put('/visitas/'+this.c_visita.id, this.c_visita)
      promise
        .then(response => {
